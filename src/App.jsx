...
export default function App() {
  ...
  // Word export disabled due to poor rendering quality
  ...
  // const wordIcon = `${basePath}word.png`; // Disabled - Word export removed
      ...
      <div className="layout">
        ...
        <aside className="sidebar">
          ...
          >
            ...
            {/* Word export button disabled due to poor rendering quality */}
            {/* <button
              type="button"
              className="focus-ring"
